...
/* Фича Мишы, которую за него писали индусы */
...
function max_counts(ar1, ar2, ar3, i1, i2, i3) {
	...
	if (comparing_with_maya(a1, a2, a3) && checkLine) {
